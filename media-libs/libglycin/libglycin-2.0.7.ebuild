...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.0.7/glycin-2.0.7.tar.bz2 -> libglycin-2.0.7.tar.bz2
mirror://macaroni/libglycin-2.0.7-mark-rust-bundle.tar.xz -> libglycin-2.0.7-mark-rust-bundle.tar.xz"
