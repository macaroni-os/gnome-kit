...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.1.1/glycin-2.1.1.tar.bz2 -> libglycin-2.1.1.tar.bz2
mirror://macaroni/libglycin-2.1.1-mark-rust-bundle.tar.xz -> libglycin-2.1.1-mark-rust-bundle.tar.xz"
