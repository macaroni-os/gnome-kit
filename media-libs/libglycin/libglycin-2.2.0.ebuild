...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.2.0/glycin-2.2.0.tar.bz2 -> libglycin-2.2.0.tar.bz2
mirror://macaroni/libglycin-2.2.0-mark-rust-bundle.tar.xz -> libglycin-2.2.0-mark-rust-bundle.tar.xz"
