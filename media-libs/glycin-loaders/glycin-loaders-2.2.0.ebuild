...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.2.0/glycin-2.2.0.tar.bz2 -> glycin-loaders-2.2.0.tar.bz2
mirror://macaroni/glycin-loaders-2.2.0-mark-rust-bundle.tar.xz -> glycin-loaders-2.2.0-mark-rust-bundle.tar.xz"
