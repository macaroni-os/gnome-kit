...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.1.1/glycin-2.1.1.tar.bz2 -> glycin-loaders-2.1.1.tar.bz2
mirror://macaroni/glycin-loaders-2.1.1-mark-rust-bundle.tar.xz -> glycin-loaders-2.1.1-mark-rust-bundle.tar.xz"
