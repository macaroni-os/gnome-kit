...
SRC_URI="
https://gitlab.gnome.org/GNOME/glycin/-/archive/2.0.8/glycin-2.0.8.tar.bz2 -> glycin-loaders-2.0.8.tar.bz2
mirror://macaroni/glycin-loaders-2.0.8-mark-rust-bundle.tar.xz -> glycin-loaders-2.0.8-mark-rust-bundle.tar.xz"
