...
SRC_URI="https://download.gnome.org/sources/gnome-control-center/48/gnome-control-center-48.7.tar.xz -> gnome-control-center-48.7.tar.xz"
...
RDEPEND="gnome-online-accounts? (
	...
	>=gnome-base/gnome-settings-daemon-48[colord,input_devices_wacom?]
