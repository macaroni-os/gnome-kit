...
SRC_URI="https://download.gnome.org/sources/mutter/48/mutter-48.7.tar.xz -> mutter-48.7.tar.xz"
LICENSE="GPL-2+"
SLOT="0"
KEYWORDS="*"
...
src_install() {
	meson_src_install
	# This file seems not generated. Maybe for systemd migration.
	# Add a workaround for now.
	insinto /usr/share/applications/
	doins "${FILESDIR}"/mutter.desktop
}
pkg_postinst() {
