...
SRC_URI="https://www.webkitgtk.org/releases/webkitgtk-2.50.4.tar.xz -> webkitgtk-2.50.4.tar.xz"
LICENSE="LGPL-2+ BSD"
SLOT="4"
KEYWORDS="*"
...
src_install() {
	cmake_src_install
	mv "${ED}"/usr/bin/WebKitWebDriver "${ED}"/usr/bin/WebKitWebDriver-4
}
