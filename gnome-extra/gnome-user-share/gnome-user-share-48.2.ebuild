...
SRC_URI="
https://download.gnome.org/sources/gnome-user-share/48/gnome-user-share-48.2.tar.xz -> gnome-user-share-48.2.tar.xz
mirror://macaroni/gnome-user-share-48.2-mark-rust-bundle.tar.xz -> gnome-user-share-48.2-mark-rust-bundle.tar.xz"
