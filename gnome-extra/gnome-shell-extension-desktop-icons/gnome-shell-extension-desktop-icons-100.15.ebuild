...
SRC_URI="https://gitlab.com/smedius/desktop-icons-ng/-/archive/Gtk4-100.15/desktop-icons-ng-Gtk4-100.15.tar.bz2 -> gnome-shell-extension-desktop-icons-gtk4-100.15.tar.bz2"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="*"
...
DEPEND="${RDEPEND}
"
S="${WORKDIR}/desktop-icons-ng-Gtk4-100.15"
pkg_preinst() {
