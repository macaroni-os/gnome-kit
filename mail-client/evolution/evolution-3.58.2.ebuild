...
SRC_URI="https://download.gnome.org/sources/evolution/3.58/evolution-3.58.2.tar.xz -> evolution-3.58.2.tar.xz"
...
RDEPEND="app-crypt/libsecret
	...
	>=gnome-extra/evolution-data-server-3.58.2:=[gtk,weather?]
	net-libs/libsoup:3
